...
export const EXPERIENCE = [
  'Worked on a variety of mobile applications, including e-commerce, bills payment, social networking, and productivity apps.',
  'Collaborated with cross-functional teams to develop, test and maintain applications from concept to deployment.',
  'Optimized app performance and improved user experience through code refactoring and implementing best practices.',
  'Familiar with state management solutions like Redux to handle complex application states.',
  'Proficient in integrating third-party libraries and APIs to extend app functionality.',
];

export const CERTIFICATION = ['Mobile Web Specialist'];
...
export const PROJECTS = [
  ...
  },
  {
    ...
    tools: ['React Native', 'Typescript', 'Redux', 'RESTful API', 'Videos'],
  },
  {
    name: 'Remind Me',
    ...
    tools: ['React Native', 'Typescript', 'Redux', 'Push notification'],
  },
];
